...
"""
Defines the module with the ISimulationProcessFactory interface.
...
class ISimulationProcessFactory(object):
    """
    Defines the interface of process simulation factory.
    @author: Luiz Gustavo 
    @organization: Federal University of Rio de Janeiro
    @contact: lglmoura@cos.ufrj.br 
    @since: 28/10/2009
